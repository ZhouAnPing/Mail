...
namespace TripolisDialogueAdapterWs
{
    ...
    public class MailAdapter : System.Web.Services.WebService
    {
        ...
        /// <param name="directEmail">parameters related with direct email, such as subject, fromaddress</param>
        /// <returns></returns>
        public String publishingSmallScaleEmail(Authorization authorization, DialogueSetting dialogueSetting, ContactGroup contactGroup, byte[] contacts, DirectEmail directEmail)
        {
            DialogueService_new dialogueService_new = new DialogueService_new(authorization.client, authorization.username, authorization.password, null);
            return dialogueService_new.publishingSmallScaleEmail(dialogueSetting, contactGroup, contacts, directEmail);
        }
        [WebMethod]
        /// <summary>
        /// send single email 
        ...
        /// <returns></returns>
        public String sendSingleEmail(Authorization authorization, DialogueSetting dialogueSetting, DirectEmail directEmail, KeyValuePair<String, String>[] ContactInfos)
        {
            DialogueService_new dialogueService_new = new DialogueService_new(authorization.client, authorization.username, authorization.password, null);
        ...
        /// <param name="ContactInfos">parameters related with contact information, such as email Id.</param>
        /// <returns></returns>
        public String registerContact(Authorization authorization, DialogueSetting dialogueSetting, KeyValuePair<String, String>[] ContactInfos)
        {
            DialogueService_new dialogueService_new = new DialogueService_new(authorization.client, authorization.username, authorization.password, null);
