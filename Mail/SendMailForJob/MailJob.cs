        ...
        public int Loop4Mail()
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    String fromName = Settings.Default.fromName;// "51Job";
                    ...
                    if (!String.IsNullOrEmpty(ftpFileName))
                    {
                        ...
                        if (String.IsNullOrEmpty(subject) || String.IsNullOrWhiteSpace(subject))
                        {
                         ...
                         diaLogueSeriveFor51.sendMail(ftpFileName, contactDatabaseId, workspaceId, emailTypeId, fromName, fromAddress, reportReceiverAddress, ftpAccountId, subject, htmlSource);
