    ...
    public partial class frmMailReSend : Form
    {
        ...
        private void worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            for (int i = 0; i < dgAgentFee.RowCount; i++)
            {
                ...
                wechatAction.sendMessageToWechat(dgAgentFee[0, i].Value.ToString(), this.dtFeeMonth.Value.ToString("yyyy-MM") + url, Settings.Default.Wechat_Secret, Settings.Default.Wechat_Agent_Department);
