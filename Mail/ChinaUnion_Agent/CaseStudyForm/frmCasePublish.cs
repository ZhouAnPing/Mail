...
namespace ChinaUnion_Agent.CaseStudyForm
{
    public partial class frmCasePublish : frmBase
    {
        ...
        private void prepareGrid(String condition)
        {
            ...
            IList<Policy> policyList = policyDao.GetAllList(condition,"案例分享");
