        ...
        private void worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dgAgentFee.RowCount; i++)
                {
                    ...
                    wechatAction.sendMessageToWechat(dgAgentFee[0, i].Value.ToString(), this.dateTimePicker1.Value.ToString("yyyy-MM") + url, Settings.Default.Wechat_Secret, Settings.Default.Wechat_Agent_Department);
