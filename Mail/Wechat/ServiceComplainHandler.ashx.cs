...
{
    /// <summary>
    /// Summary description for ServiceComplainHandler
    /// </summary>
    public class ServiceComplainHandler : IHttpHandler
    {

        private log4net.ILog logger = log4net.LogManager.GetLogger(typeof(ServiceComplainHandler));
        /// <summary>
        /// 处理企业号的信息
        /// </summary>
