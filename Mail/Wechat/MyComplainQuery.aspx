<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyComplainQuery.aspx.cs" Inherits="Wechat.MyComplainQuery" %>
                            ...
                            正在加载数据.............
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="30" AllowPaging="True"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:BoundField DataField="userId" HeaderStyle-BorderWidth="0" HeaderText="用户" ReadOnly="True" ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="0" ItemStyle-BorderColor="Black" />

                                            
                                       
                                        <asp:HyperLinkField DataNavigateUrlFields="seq,userId" HeaderStyle-BorderWidth="0" DataNavigateUrlFormatString="./MyComplainReply.aspx?seq={0}&userId={1}" DataTextField="processCode" HeaderText="受理号码" ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="0" ItemStyle-BorderColor="Black" />
                                        <asp:HyperLinkField DataNavigateUrlFields="seq,userId" HeaderStyle-BorderWidth="0" DataNavigateUrlFormatString="./MyComplainReply.aspx?seq={0}&userId={1}" DataTextField="content" HeaderText="投诉内容" ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="0" ItemStyle-BorderColor="Black" />
                                          <asp:BoundField DataField="replyTime" HeaderStyle-BorderWidth="0" HeaderText="截止时间" ReadOnly="True" ItemStyle-BorderWidth="0" ItemStyle-BorderColor="Black" ItemStyle-HorizontalAlign="Left" /> 
