                ...
                <tr>
                    <td style="font-size: 25px; color: black; font-weight: normal; text-align: left; font-family: Georgia, Times, serif; line-height: 45px; vertical-align: top; padding:0px 30px 30px 30px" bgcolor="#ffffff">
                        <table width="100%"  class="deviceWidth" border="1" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff">
                        	<tr>
			                    <td  style="font-size: 25px; color: black; font-weight: normal; text-align: left; font-family: Georgia, Times, serif; line-height: 45px; vertical-align: bottom; padding:0px; background-color: #006699;" bgcolor="#006699" >
                                              <a href="#"><img src="./ChinaUnicom.png" alt="" border="0"  /></a></td>
			               <td  style="font-size: 25px; color: white; font-weight: normal; text-align: left; font-family: Georgia, Times, serif; line-height: 45px; vertical-align:middle; padding:0px; background-color: #006699;" bgcolor="#006699" colspan="3">
                                              <b style="font-size: 40px; text-align: center">&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;上海联通合作伙伴佣金告知单</b></td>
