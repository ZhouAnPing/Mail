...
namespace Tencent
{
    class WXBizMsgCrypt
    {
        private log4net.ILog logger = log4net.LogManager.GetLogger(typeof(WXBizMsgCrypt));
        string m_sToken;
        ...
        public int VerifyURL(string sMsgSignature, string sTimeStamp, string sNonce, string sEchoStr, ref string sReplyEchoStr)
        {
            ...
            {
                logger.Info("AES_decrypt fail");
                sReplyEchoStr = "";
                return (int)WXBizMsgCryptErrorCode.WXBizMsgCrypt_DecryptAES_Error;
            }
            if (cpid != m_sCorpID)
            {
                logger.Info("WXBizMsgCrypt_ValidateCorpid_Error fail");
                sReplyEchoStr = "";
