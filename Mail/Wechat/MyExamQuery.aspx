<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyExamQuery.aspx.cs" Inherits="Wechat.MyExamQuery" %>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" PageSize="30" AllowPaging="True"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:BoundField DataField="userId" HeaderStyle-BorderWidth="0" HeaderText="登录用户" ReadOnly="True" ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="0" ItemStyle-BorderColor="Black" />
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFields="seq,userId" HeaderStyle-BorderWidth="0" DataNavigateUrlFormatString="./OnlineExam.aspx?seq={0}&userId={1}" DataTextField="subject" HeaderText="名称" ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="0" ItemStyle-BorderColor="Black" />
                                        <asp:HyperLinkField DataNavigateUrlFields="seq,userId" HeaderStyle-BorderWidth="0" DataNavigateUrlFormatString="./OnlineExam.aspx?seq={0}&userId={1}" DataTextField="status" HeaderText="状态" ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="0" ItemStyle-BorderColor="Black" />
