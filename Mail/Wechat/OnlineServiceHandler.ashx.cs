...
{
    /// <summary>
    /// Summary description for OnlineServiceHandler
    /// </summary>
    public class OnlineServiceHandler : IHttpHandler
    {

        private log4net.ILog logger = log4net.LogManager.GetLogger(typeof(OnlineServiceHandler));
        /// <summary>
        /// 处理企业号的信息
        /// </summary>
