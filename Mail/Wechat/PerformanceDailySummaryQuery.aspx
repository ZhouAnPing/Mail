			                ...
			                <tr>
			                    <td  style="font-size: 20px; color: black; font-weight: normal; text-align: center; font-family: Microsoft YaHei, Calibri, Arival; line-height: normal; vertical-align: top; padding:5px" bgcolor="white">
			                        	<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                ...
                                                <Columns>  
                                                    <asp:BoundField DataField="date" HeaderText="日期"  ReadOnly="True"  ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Black" ItemStyle-Wrap="true" />         
                                                    <asp:BoundField DataField="branchNo" HeaderText="门店编号"  ReadOnly="True"  ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Black" ItemStyle-Wrap="true" />         
                                                     <asp:HyperLinkField DataNavigateUrlFields="branchNo,branchName,date" DataNavigateUrlFormatString="./PerformanceDailyDetailQuery.aspx?branchNo={0}&branchName={1}&date={2}" DataTextField="branchName" HeaderText="门店名称"  ItemStyle-HorizontalAlign="Left" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Black"/>

                                                   
                                                    <asp:BoundField DataField="fee1" HeaderText="后付费发展数" ReadOnly="True"  ItemStyle-HorizontalAlign="right" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Black" />
                                                    <asp:BoundField DataField="fee2" HeaderText="预付费发展数" ReadOnly="True" ItemStyle-HorizontalAlign="right" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Black"/>
