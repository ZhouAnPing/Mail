      ...
      <table width="100%"  class="deviceWidth" border="1" cellpadding="0" cellspacing="0" align="center" bgcolor="#ffffff">
          ...
          <tr>
                 ...
                 <td   style="font-size: 16px; color: black; font-weight: normal; text-align: left; font-family: Microsoft YaHei, Calibri, Arival; line-height: normal; vertical-align: top; padding:0px">
                     <asp:TextBox  ID="txtSubject"  Width="98%" runat="server" Height="40px"></asp:TextBox>
                 </td>               
            </tr>
             <tr>
                 ...
                 <td   style="font-size: 16px; color: black; font-weight: normal; text-align: left; font-family: Microsoft YaHei, Calibri, Arival; line-height: normal; vertical-align: top; padding:0px">
                     <asp:TextBox ID="txtContent" runat="server" Height="210px" TextMode="MultiLine" Width="98%"></asp:TextBox>
                 </td>               
            </tr>
           <tr>
                 ...
                 <td   style="font-size: 16px; color: black; font-weight: normal; text-align: left; font-family: Microsoft YaHei, Calibri, Arival; line-height: normal; vertical-align: top; padding:0px">
                     <asp:DropDownList ID="ddlDepartment" runat="server" Height="40px" Width="98%">
          ...
          <tr>
                 <td colspan="2"  style="font-size: 16px; color:  black; background-color:white; font-weight: bold; text-align: center; font-family: Microsoft YaHei, Calibri, Arival; line-height:normal; vertical-align: top; padding:0px" >
                     <br />
                     <asp:Button ID="btnSubmit" runat="server"  Width="90%" Text="提交" Height="38px" OnClick="btnSubmit_Click" />
                 <br />
                 </td>   
