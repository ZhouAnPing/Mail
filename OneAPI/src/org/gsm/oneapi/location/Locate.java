...
/**
 * The main API interface for the OneAPI Location methods
 */
public class Locate {
	 ...
	 */	
	public Locate(ServiceEndpointsInterface endPoints, String authorisationHeader) {
	...
	@see org.gsm.oneapi.endpoints.ServiceEndpoints
	 */	
	public Locate(ServiceEndpointsInterface endPoints, String username, String password) {
		String authorisationHeader=null;
