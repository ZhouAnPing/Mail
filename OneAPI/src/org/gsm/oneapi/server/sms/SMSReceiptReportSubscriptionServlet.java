...
public class SMSReceiptReportSubscriptionServlet extends OneAPIServlet implements Runnable {
	...
	private void processSMS(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String msg = nullOrTrimmed(request.getParameter("msg"));
		...
		logger.debug("Mobile message = " + msg);
	...
	public void doPost_old(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (validateRequest(request, response, requestParts, validationRules)) {
			...
			ValidationRule[] rules = { new ValidationRule(ValidationRule.VALIDATION_TYPE_MANDATORY, "destinationAddress", destinationAddress),
					new ValidationRule(ValidationRule.VALIDATION_TYPE_MANDATORY_URL, "notifyURL", notifyURL), new ValidationRule(ValidationRule.VALIDATION_TYPE_OPTIONAL, "criteria", criteria),
