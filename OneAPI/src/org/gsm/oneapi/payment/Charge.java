...
/**
 * The main API interface for the OneAPI Payment Charge methods
 */
public class Charge {
	 ...
	 */	
	public Charge(ServiceEndpointsInterface endPoints, String authorisationHeader) {
	...
	@see org.gsm.oneapi.endpoints.ServiceEndpoints
	 */	
	public Charge(ServiceEndpointsInterface endPoints, String username, String password) {
		String authorisationHeader=null;
