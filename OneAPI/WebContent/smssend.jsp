...
<%
	...
	if (submit==null) {
		...
		address0="tel:+13671935968";
		//address1="tel:+13500000992";
		//message="预祝中秋节快乐平安！【优赞】";
		...
		username="dl-chenl";
		password="654321";
		endpoint=sandboxEndpoints.getSendSMSEndpoint();

	} else {
		sandboxEndpoints.setSendSMS(endpoint);

		SMSSend me=new SMSSend(sandboxEndpoints, username, password);
		
		String[] addressList={address0, address1, address2, address3, address4};
		
		//message = "é¢ç¥ä¸­ç§èå¿«ä¹å¹³å®ï¼ãä¼èµã";
